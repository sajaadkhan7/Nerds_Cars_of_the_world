...
<div class="bg-white">
  ...
  <div class="row align-items-center">
      <div class="col-lg-5 px-5 mx-auto"><img src="assets/images/about-2.png" alt="" class="img-fluid mb-4 mb-lg-0"></div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="assets/images/undraw_fast_car_p4cu.png" alt="" class="img-fluid mb-lg-0"></div>
    </div>
