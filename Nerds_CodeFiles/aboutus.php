...
<div class="bg-white">
  ...
  <div class="row align-items-center">
      ...
      <div data-aos='fade-right' data-aos-delay="0" data-aos-duration="1000" class="col-lg-5 px-5 mx-auto"><img src="assets/images/about-2.png" alt="" class="img-fluid mb-4 mb-lg-0"></div>
      <div data-aos='fade-left' data-aos-delay="0" data-aos-duration="1000" class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
    ...
    <div class="row align-items-center mb-5">
      <div data-aos='fade-right' data-aos-delay="0" data-aos-duration="1000" class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>

        <h2 class="font-weight-light">Time Period for Car rental</h2>
        <p class="font-italic text-muted">Our company allows any customer to get a car on rent for even more than years. Further More, We do not require ask for extra fees if they delay the while returning it. 
      We just give a warning email which explains if delay has occured so you know when to reurn.</p>
      </div> 

      <div data-aos='fade-left' data-aos-delay="0" data-aos-duration="1000" class="col-lg-5 px-5 mx-auto order-1 order-lg-2"><img src="assets/images/undraw_fast_car_p4cu.png" alt="" class="img-fluid mb-4 mb-lg-0"></div>
