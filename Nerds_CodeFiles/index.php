  ...
  <div class="row" id="overlay-text">
    <div class="col-sm-12 my-auto">
      <div class="banner_content text-white">
        <h1 class="fw-md-bolder" style="letter-spacing: normal;">Rent the car of your choice.</h1>
        <p>Choose from various brands that suits you the best. </p>
        <a href="#cars" class="btn btncolor mt-auto text-white text-uppercase"><b>Find Your Car</b><span class="angle_arrow"><i
